...
if __name__ == "__main__":
    ...
    lm = OpenAI(
        api_key="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",        # ✅ your OpenAI API key
        model_name="gpt-4o",     # ✅ correct keyword is `model_name`, not `model`
