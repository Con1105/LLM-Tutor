...
def get_kg():
    return KGGen(
        model="openai/gpt-4o",
        temperature=0.0,
        api_key=st.secrets["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"]
    )
...
def convert_entities_to_dependency_dict(graph, client):
    ...
    - The **value** is a dictionary of its direct prerequisite concepts found from curiculums/courses.
